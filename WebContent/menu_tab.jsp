<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
		...
		<%
			...
			if(myauth.equals("1")){
				...
				out.println("<li><a href='mycart.jsp' class='nav'>购 物 车</a></li>");
				out.println("<li class='divider'></li>");
				out.println("<li><a href='orderbuy.jsp' class='nav'>我 的 订 单</a></li>");
			}else if(myauth.equals("2")){
				out.println("<li><a href='upload.jsp' class='nav'>发 布 新 物 品</a></li>");
				out.println("<li class='divider'></li>");
				out.println("<li><a href='myitem.jsp' class='nav'>我 的 物 品</a></li>");
				out.println("<li class='divider'></li>");
				out.println("<li><a href='ordersell.jsp' class='nav'>订 单 管 理</a></li>");
			}else{
				out.println("<li><a href='itemlist.jsp' class='nav'>物 品 管 理</a></li>");
				out.println("<li class='divider'></li>");
		...
		%>
            ...
            <li class="divider"></li>
            <li><a href="logoff.jsp" class="nav">登 出</a></li>
			<li class="divider"></li>
