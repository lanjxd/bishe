...
<div id="main_container">
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">长袖连衣裙 已添加到购物车</div>
                 ...
                 <a href="javascript:popImage('images/p1.jpg')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/p1.jpg" alt="" title="" border="0" /></a>
                     ...
                     <div class="details_big_box">
                         ...
                         <div class="specifications">
                            数量: <span class="blue">1</span><br/>
							总价: <span class="blue">￥ 150</span><br/>
                         </div>
                         
						 <br/><br/>
                         <a href="index1.jsp" class="prod_buy">继续购物</a>
                         <a href="item1.jsp" class="prod_favor">删 除</a>
                     </div>                        
            </div>
